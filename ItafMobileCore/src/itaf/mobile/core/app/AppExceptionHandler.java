...
public class AppExceptionHandler implements UncaughtExceptionHandler {
	...
	private static final String LOG_PATH = "/cctvnewsmobile/applog/";

	private static class SingletonHolder {
		static final AppExceptionHandler instance = new AppExceptionHandler();
	}
	...
	private String getFilePath() {
		...
		if (isSDCardExist && isRootDirExist) {
			...
			file_dir = AppApplication.getInstance().getFilesDir().getAbsolutePath()
					+ LOG_PATH;
		}
		return file_dir;
	}
	...
	private String saveCatchInfo2File(Throwable ex) {
		...
		try {
			...
			String fileName = "applog-" + time + "-" + timestamp + ".log";
