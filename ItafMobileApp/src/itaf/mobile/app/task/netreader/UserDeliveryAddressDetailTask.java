 ...
 * @update 2013年8月27日
 */
public class UserDeliveryAddressDetailTask extends ReaderTask {
	...
	public UserDeliveryAddressDetailTask(BaseActivity activity,
			Map<String, Object> map) {
		super(activity, getTaskId(), map);
	}

	public static int getTaskId() {
		return TaskIds.TASK_USER_DELIVERY_ADDRESS_DETAIL;
	}
