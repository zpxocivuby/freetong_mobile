 ...
 * 
 */
public class ProductFavoriteTask extends ReaderTask {
	...
	public ProductFavoriteTask(BaseActivity activity, Map<String, Object> map) {
	...
	public void loadMsgObj() {
		...
		WsPageResult<BzProductFavoriteDto> result = client.productFavorite(
