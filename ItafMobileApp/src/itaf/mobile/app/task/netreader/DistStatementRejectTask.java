 ...
 * 
 */
public class DistStatementRejectTask extends ReaderTask {
	...
	public DistStatementRejectTask(BaseActivity activity,
			Map<String, Object> map) {
		super(activity, getTaskId(), map);
	}

	public static int getTaskId() {
		return TaskIds.TASK_DIST_STATEMENT_REJECT;
	}
	...
	public void loadMsgObj() {
		...
		WsPageResult<BzDistStatementDto> result = client.rejectDistStatement(
