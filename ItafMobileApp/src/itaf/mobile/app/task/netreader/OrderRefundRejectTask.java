 ...
 * 
 */
public class OrderRefundRejectTask extends ReaderTask {
	...
	public OrderRefundRejectTask(BaseActivity activity, Map<String, Object> map) {
		super(activity, getTaskId(), map);
	}

	public static int getTaskId() {
		return TaskIds.TASK_REFUND_REJECT;
	}
	...
	public void loadMsgObj() {
		...
		WsPageResult<BzOrderRefundDto> result = client.rejectRefund(
