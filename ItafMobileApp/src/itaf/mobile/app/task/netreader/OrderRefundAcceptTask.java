 ...
 * 
 */
public class OrderRefundAcceptTask extends ReaderTask {
	...
	public OrderRefundAcceptTask(BaseActivity activity, Map<String, Object> map) {
		super(activity, getTaskId(), map);
	}

	public static int getTaskId() {
		return TaskIds.TASK_REFUND_ACCEPT;
	}
	...
	public void loadMsgObj() {
		...
		WsPageResult<BzOrderRefundDto> result = client.acceptRefund(
