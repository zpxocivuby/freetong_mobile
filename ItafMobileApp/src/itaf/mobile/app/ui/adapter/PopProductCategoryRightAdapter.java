 ...
 */
public class PopProductCategoryRightAdapter extends BaseAdapter {
	...
	public PopProductCategoryRightAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tv_pcra_content.setText(content.get(position)
				.getCategoryName());
