 ...
 */
public class PopServiceProviderTypeLeftAdapter extends BaseAdapter {
	...
	public PopServiceProviderTypeLeftAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv_pcla_content.setText(content.get(position).getTypeName());
